class PetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pet.save
        format.html { redirect_to @pet, success: 'Pet was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @pet.update(pet_params)
        format.html { redirect_to @pet, success: 'Pet was successfully updated.' }
  ...
  def destroy
    @pet.destroy
    respond_to do |format|
      format.html { redirect_to pets_url, success: 'Pet was successfully destroyed.' }
