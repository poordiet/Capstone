class GroomingAppointmentsController < ApplicationController
  ...
  private
    ...
    def grooming_appointment_params
      params.require(:grooming_appointment).permit(:pet_id, :store_id, :payment_type_id, :appt_date, :appt_time, :appt_blades, 
        :appt_total, :appt_total, :appt_notes, :customer_feedback, :vac_current, :vac_current_date, :grooming_appointment_status_id,
