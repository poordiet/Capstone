...
class IncidentsTest < ApplicationSystemTestCase
  ...
  test "creating a Incident" do
    ...
    fill_in "Grooming appointment", with: @incident.grooming_appointment_id
    fill_in "Incident cost", with: @incident.incident_cost
    fill_in "Incident notes", with: @incident.incident_notes
