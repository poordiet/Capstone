...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { grooming_appointment_id: @incident.grooming_appointment_id, incident_cost: @incident.incident_cost, incident_notes: @incident.incident_notes } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { grooming_appointment_id: @incident.grooming_appointment_id, incident_cost: @incident.incident_cost, incident_notes: @incident.incident_notes } }
