...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { style_description: @style.style_description, style_name: @style.style_name } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { style_description: @style.style_description, style_name: @style.style_name } }
